package ${project.groupId}.${project.name}.server.config;
...
public class GlobalExceptionHandlerConfig {
    @ExceptionHandler(value = ${project.class}Exception.class)
    @ResponseBody
    public ResultDto<String> jsonHandler(HttpServletRequest request, ${project.class}Exception e) {
